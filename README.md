...
- [CI auto build]([https://ci.appveyor.com/api/projects/hozuki/mltdtools/artifacts/miritore-appveyor-latest.zip](https://ci.appveyor.com/project/DavidMax-dm/mltdtools)) (unstable, but may contain latest fixes) (Windows)
